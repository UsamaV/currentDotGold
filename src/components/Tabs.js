    ...
    <div className="px-16 py-20 bg-slate-50">
      ...
      <div className="Tabs">
        <ul className="nav flex justify-between w-3/4 mx-auto">
          ...
          <TabNavItem title="Peshawar" id="tab4" activeTab={activeTab} setActiveTab={setActiveTab} />
          <TabNavItem title="Quetta" id="tab5" activeTab={activeTab} setActiveTab={setActiveTab} />
          <TabNavItem title="Sialkot" id="tab6" activeTab={activeTab} setActiveTab={setActiveTab} />
        </ul>
